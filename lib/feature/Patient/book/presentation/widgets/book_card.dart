...
class BookCard extends StatelessWidget {
  ...
  Column(
    ...
    children: [
      ...
      const SizedBox(height: 4,),
         Text("7 Years experience",style: AppStyles.styleRegular12(),),
      const SizedBox(height: 4,),
      Row(
        children: [
          Container(
  ...
  decoration: ShapeDecoration(
    ...
    shape: OvalBorder(),
          ...
          const SizedBox(width: 4,),
          Text("69 Patient Stories",style: AppStyles.styleLight10()),
        ],
      )
          ...
          Row(
            children: [
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text("Next Available",style: AppStyles.styleRegular14().copyWith(color: AppColors.colorGradientGreenEnd),),
                  const SizedBox(height: 5,),
                  Text("10:00 AM tomorrow",style:AppStyles.styleRegular14(),)
                ],
              ),
             const Spacer(),
             const BookButton()
